...
(990, (49, 56), iCeltia, '&#193;th Cliath', 2, iArcher, 2),			# Dublin
...
class Barbs:
	...
	def checkTurn(self, iGameTurn):
		...
		if utils.isYearIn(-650, 550):
			self.checkSpawn(iBarbarian, iVikingLongboat, 1, (50, 49), (61, 55), self.spawnPirates, iGameTurn, 20, 0, ["TXT_KEY_ADJECTIVE_NORSE"])
